...
## Creates a histogram of Global Active Power and saves it as "plot1.png" in the figure directory
png(file = paste0(fig, "/plot1.png"), width = 480, height = 480, bg = "white")
hist(dt[, Global_active_power], bty = "n", col = "red", main = "Global Active Power", xlab = "Global Active Power (kilowatts)", ylab = "Frequency")
dev.off()
